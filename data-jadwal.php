                ...
                <tbody>
                    ...
                    <?php foreach( $jadwal as $row ) : ?>
                        ...
                        <tr>
                            ...
                            <a href="ubah-jadwal.php?kd_jadwal=<?= $row["kd_jadwal"]; ?>" ><button type="button" class="btn btn-warning">Edit</button></a>
                            <a href="hapus-jadwal.php?kd_jadwal=<?= $row["kd_jadwal"]; ?>" ><button type="button" class="btn btn-danger">Delete</button></a>
                            </td>
                        </tr>
                    <?php $i++; ?>
	                <?php endforeach; ?>
