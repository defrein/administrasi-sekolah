            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a href="ubah-siswa.php?nis=<?= $row["nis"]; ?>" ><button type="button" class="btn btn-warning">Edit</button></a>
                        <a href="hapus-siswa.php?nis=<?= $row["nis"]; ?>" ><button type="button" class="btn btn-danger">Delete</button></a>
                        </td>
                    </tr>
                    <?php $i++; ?>
	                <?php endforeach; ?>
