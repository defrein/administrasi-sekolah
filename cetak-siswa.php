                ...
                <form action="" method="post">
                    ...
                    <label for="kd_kelas" class="col-4 col-form-label">Pilih Kode Kelas</label> 
                        ...
                        <select id="kd_kelas" name="kd_kelas" class="custom-select">
                            <option value="B100" <?=$kd_kelas == 'B100' ? ' selected="selected"' : '';?>>B100</option>
                            <option value="B110" <?=$kd_kelas == 'B110' ? ' selected="selected"' : '';?>>B110</option>
                            <option value="B120" <?=$kd_kelas == 'B120' ? ' selected="selected"' : '';?>>B120</option>
                            <option value="M100" <?=$kd_kelas == 'M100' ? ' selected="selected"' : '';?>>M100</option>
                            <option value="M110" <?=$kd_kelas == 'M110' ? ' selected="selected"' : '';?>>M110</option>
                            <option value="M120" <?=$kd_kelas == 'M120' ? ' selected="selected"' : '';?>>M120</option>
                            <option value="S100" <?=$kd_kelas == 'S100' ? ' selected="selected"' : '';?>>S100</option>
                            <option value="S110" <?=$kd_kelas == 'S110' ? ' selected="selected"' : '';?>>S110</option>
                            <option value="S120" <?=$kd_kelas == 'S120' ? ' selected="selected"' : '';?>>S120</option>
                        </select>                        
                    </div>
                    <div class="buttons">
                        <button type="button" class="btn btn-danger" style="margin-right:10px;"><a href="data-siswa.php" style="color: #fff; text-decoration:none; "> Batal</a></button>
